...
questCompleted = function(questId) {
  return $gameSystem.isQuestCompleted(questId);
};

questFailed = function(questId) {
  return $gameSystem.isQuestFailed(questId);
};

questAvailable = function(questId) {
  return $gameSystem.isQuestAvailable(questId);
};

questAdded = function(questId) {
  return $gameSystem.isQuestAdded(questId);
};

objComp = function(questId, objId) {
  return $gameSystem.isQuestObjectiveCompleted(questId, objId);
};

objFailed = function(questId, objId) {
  return $gameSystem.isQuestObjectiveFailed(questId, objId);
};

objAvailable = function(questId, objId) {
  return $gameSystem.isQuestObjectiveAvailable(questId, objId);
};
