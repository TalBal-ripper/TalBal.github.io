...
if (Imported.YEP_BattleEngineCore) {
  if (Yanfly.BEC.version && Yanfly.BEC.version >= 1.42) {
    ...
    Yanfly.Param.CTBPreEmptive = Number(
      Yanfly.Parameters["Pre-Emptive Bonuses"],
    );
    ...
    Yanfly.Param.CTBEscapeBoost = Number(
      Yanfly.Parameters["Fail Escape Boost"],
    );
    ...
    Yanfly.Param.CTBDefaultSpeed = Number(
      Yanfly.Parameters["Default CTB Speed"],
    );
    ...
    Yanfly.Param.CTBColorAllyBr = Number(
      Yanfly.Parameters["Ally Border Color"],
    );
    ...
    Yanfly.Param.CTBColorEnemyBg = Number(
      Yanfly.Parameters["Enemy Back Color"],
    );
    ...
    Yanfly.CTB.BattleManager_selectNextCommand =
    ...
    Yanfly.CTB.Game_Actor_setBattlerImage =
    ...
    var text =
      "================================================================\n";
    text +=
      "YEP_X_AnimatedSVEnemies requires YEP_BattleEngineCore to be at the ";
    text +=
      "latest version to run properly.\n\nPlease go to www.yanfly.moe and ";
    text +=
      "update to the latest version for the YEP_BattleEngineCore plugin.\n";
    text +=
      "================================================================\n";
    console.log(text);
    require("nw.gui").Window.get().showDevTools();
