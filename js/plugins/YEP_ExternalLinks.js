 ...
 * 
 * @param Choose android or win
 * @desc This is choosing of version you need
 * @default win
 *
 * @help
 * ============================================================================
...
Yanfly.Param.AndroidOrPC = String(Yanfly.Parameters['Choose android or win']);
...
Scene_Title.prototype.commandHomePage = function() {
	...
	if (Yanfly.Param.AndroidOrPC === 'win') {
		var win = require('nw.gui').Shell.openExternal(Yanfly.Param.HomePageUrl);
	} else if (Yanfly.Param.AndroidOrPC === 'android'){
