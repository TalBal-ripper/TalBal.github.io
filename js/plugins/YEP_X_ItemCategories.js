 ...
 * @default Misc
 *
 * @param Untagged Items
 * @parent ---Naming---
 * @desc How this category is named in the Item Menu
 * @default UntaggedItems
 *
 * @help
 * ============================================================================
 * Introduction
...
if (Imported.YEP_ItemCore) {
  ...
  Yanfly.SetupParameters = function () {
    ...
    Yanfly.Param.ItemCatNames = {
      ...
      UntaggedItems: String(Yanfly.Parameters["Untagged Items"]),
    };
  };
  ...
  Window_ItemCategory.prototype.addItemCategory = function (category) {
    ...
    if (category.match(/UntaggedItems/i)) {
      return this.addCommand(TextManager.item, "UntaggedItems");
    }
