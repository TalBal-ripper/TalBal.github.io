 ...
 * '#' marker. The code is used for a switch, it ought to return a 'true' or
 * 'false' boolean. If the code is used for a variable, it ought to return a
 * numeric value for comparison.
 *
 * For example, a switch named '# $gameActors.actor(1).isLearnedSkill(5)',
 ...
 * yourself the extra step by just naming a variable '# $gameParty.gold()'.
 ...
 *
 * # $gameActors.actor(2).isStateAffected(10)
 ...
 *
 * # $gameActors.actor(3).isEquipped($dataWeapons[100])
 ...
 *
 * # $gameSelfSwitches.value([10,20,'A'])
 ...
 * # $gameParty.numItems($dataWeapons[2])
 * # $gameParty.numItems($dataArmors[3])
