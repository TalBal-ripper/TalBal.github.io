...
Window_TitleCommand.prototype.windowWidth = function() {
    //if (DKTools.Localization.locale == 'ru') return 180 + 100;
    return 280;
};
...
Window_TitleCommand.prototype.makeCommandList = function() {
    ...
    this.addCommand('{Экспорт сохранений}', 'exportSave');
    this.addCommand('{Импорт сохранений}', 'importSave');
...
Window_TitleCommand.prototype.itemRect = function(index) {
    ...
    const totalHeight = this.maxItems() * this.itemHeight();
